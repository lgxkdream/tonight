...
//		System.out.println("-->"+newStr);
		...
		list.add("2014-06-17 13:29:00");
		list.add("2015-06-07 13:29:00");
		list.add("2015-06-08 13:29:00");
		list.add("2015-06-09 13:29:00");
		list.add("2015-06-10 13:29:00");
		list.add("2015-06-11 13:29:00");
		list.add("2015-06-12 10:29:00");
		list.add("2015-06-12 13:29:00");
		list.add("2015-06-12 14:29:00");
		list.add("2015-06-13 13:29:00");
		list.add("2015-06-14 13:29:00");
		list.add("2015-06-15 13:29:00");
		list.add("2015-06-16 13:29:00");
		list.add("2015-06-17 13:29:00");
		list.add("2016-06-17 13:29:00");
		try {
			for(String s:list){
				String r=getShortDateTime(s,"yyyy-MM-dd HH:mm:ss",new Date());
