...
//	   }
    ...
    public static void main(String[] args){   
        //这个类主要是设置邮件   
	     ...
	     mailInfo.setMailServerPort("25");    
	     mailInfo.setValidate(true);    
	     mailInfo.setUserName("65242847@qq.com");    
	     mailInfo.setPassword("6995202Mym");//您的邮箱密码    
	     mailInfo.setFromAddress("65242847@qq.com");    
	     mailInfo.setToAddress("604496160@qq.com");    
	     mailInfo.setSubject("测试设置邮箱标题");    
	     mailInfo.setContent("测试设置邮箱内容");    
	     //这个类主要来发送邮件   
